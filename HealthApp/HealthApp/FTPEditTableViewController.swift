//
//  FTPEditTableViewController.swift
//  HealthApp
//
//  Created by Emily K. Nguyen on 3/20/17.
...
class FTPEditTableViewController: UITableViewController {
    
    var shownFTP: Int? = 0
    var ref : FIRDatabaseReference!
    
    @IBOutlet weak var ftpDisplayText: UITextField!
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if (indexPath.section == 0 && indexPath.section == 0) {
            ftpDisplayText.becomeFirstResponder()
        }
